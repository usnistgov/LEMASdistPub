...
SMTPport = 25
#SMTPport = 587                                                                  #gmail SMTP server settings
#the email address to send messages from
logaddress = 'dmgalert@nist.gov'
fromaddress = 'dmgalert@nist.gov'
#the username and password of the email address. leave blank if login to the smtp server is not needed to send messages.
username = ''
password = ''
